...
print("Burgers Equation - Conservative with Smooth Initial Conditions")
print("=" * 70)
...
def gen_data():
    ...
    # Smooth Gaussian initial condition instead of discontinuous
    u_ic=np.exp(-10*X_star[:, 0] **2)
    u_star = np.copy(u_ic)
...
# Main execution
print("Generating data with smooth Gaussian initial conditions...")
...
plot(x, t, u_pred, title='Predicted u(x,t) - Burgers Conservative Smooth IC')
...
print("Burgers Conservative Smooth IC problem completed!")