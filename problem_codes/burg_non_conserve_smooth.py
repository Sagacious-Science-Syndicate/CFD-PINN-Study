...
print("Burgers Equation - Non-Conservative with Smooth Initial Conditions")
print("=" * 75)
...
print("Generating data with smooth initial conditions...")
...
ax1.set_title('Burgers Non-Conservative Smooth IC')
...
print("Burgers Non-Conservative Smooth IC problem completed!")